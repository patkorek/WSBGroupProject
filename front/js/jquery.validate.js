...
$.extend( $.validator, {
	...
	messages: {
		...
		date: "Wpisz datę w poprawnym formacie.",
		dateISO: "Please enter a valid date ( ISO ).",
		number: "Wpisz tylko liczbę.",
		digits: "Please enter only digits.",
		creditcard: "Please enter a valid credit card number.",
		equalTo: "Please enter the same value again.",
		maxlength: $.validator.format( "Dopuszczalna ilość znaków: {0}." ),
		minlength: $.validator.format( "Wpisz więcej niż {0} znaki." ),
		...
		digits: function( value, element ) {
			return this.optional( element ) || /^\d+$/.test( value );
                ...
                filesize: function(value, element, param) {
                    var fileSizeCorrect = true;
                    if(element.files && element.files[0]) {
                        fileSizeCorrect = element.files[0].size <= param;
                    }
                    return this.optional(element) || fileSizeCorrect;
                 },
...
return this.optional(element) || fileSizeCorrect;
                ...
                nip: function(value, element) {
                    var nip_bez_kresek = value.replace(/-/g,"");
                    var reg = /^[0-9]{10}$/;
